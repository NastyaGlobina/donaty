...
class AuthModule
{
 ...
 private function passhash($pass,$salt){
    ...
    public function register($login, $pass,$email, array $userdata=[]){
        ...
        $userdata["img"] =addslashes(file_get_contents($path));
        //$st="Insert into img values ('$img')";

        //$id=DatabaseModule::instance()->img->query($st);
        $id=DatabaseModule::instance()->users->insert($userdata);
        return $id;
       }
